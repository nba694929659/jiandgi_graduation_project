...
Box.prototype = {
	...
	initUI: function() {
		if (!this._inited)
		{		
			this.html = ['<div class="pop-float win-tips-add fixed-pop" style="display:none;">',
				'<div class="pop-t"><div></div></div>',
				'<div class="pop-m">',
				'<div class="pop-inner">',
				'<h4 id="titleBar"><a class="clos" href="#" id="close" rel="close"></a>',
				this.title,
				'</h4>',
				...
				'</div>',
				'</div>',
				'<div class="pop-inner-bg"></div></div><div class="pop-b"><div></div></div>',
				'</div>'].join('');
